...
void draw() {
  ...
  for (int i = 0;i < 3;i ++) {
    drop((int)random(640), (int)random(480), 3, 150);
  }
  if (random(100)<20) {
    drop((int)random(640), (int)random(480), (int)(random(2)+3), (int)(random(200)+200));
  }
  if (random(100)<10) {
    drop((int)random(640), (int)random(480), (int)(random(5)+5), (int)(random(500)+200));
  }
  /*
    int cx0 = int(random(640));
    int cy0 = int(random(480));
    float c = random(100)+1;
    float p = 20000/(c*c);
    for (int a= 0;a<3;a++) {
      for (int b= 0;b<3;b++) {
        int cx = cx0+a;
